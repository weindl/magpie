...
parameters
 ...
 p56_c_price_bc(t_all,i)                            C price used for biochar CDR rewards (USD17MER per tC)
...
equations
 q56_emission_costs(i)                              Calculation of total emission costs (mio. USD17MER per yr)
 q56_emission_cost_annual(i,emis_annual)            Calculation of regional costs for annual emissions (mio. USD17MER per yr)
...
variables
 vm_emission_costs(i)                               Costs for emission rights for pollutants and greenhouse gases (mio. USD17MER per yr)
 ...
 v56_emission_cost(i,emis_source)                   GHG emissions cost (mio. USD17MER per yr)
...
parameters
 ...
 ov_emission_costs(t,i,type)                        Costs for emission rights for pollutants and greenhouse gases (mio. USD17MER per yr)
 ...
 ov56_emission_cost(t,i,emis_source,type)           GHG emissions cost (mio. USD17MER per yr)
