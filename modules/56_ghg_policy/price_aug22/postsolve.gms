...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov_reward_cdr_bc(t,i,"marginal")                         = vm_reward_cdr_bc.m(i);
 ov56_reward_cdr_bc_res(t,i,"marginal")                   = v56_reward_cdr_bc_res.m(i);
 ov56_reward_cdr_bc_ded(t,i,"marginal")                   = v56_reward_cdr_bc_ded.m(i);
 ov56_luc_sens_bc_eligibility(t,i,"marginal")             = v56_luc_sens_bc_eligibility.m(i);
 ov56_cdr_bc_ded_credit(t,i,"marginal")                   = v56_cdr_bc_ded_credit.m(i);
 ...
 oq56_reward_cdr_bc_res(t,i,"marginal")                   = q56_reward_cdr_bc_res.m(i);
 oq56_reward_cdr_bc_ded(t,i,"marginal")                   = q56_reward_cdr_bc_ded.m(i);
 oq56_reward_cdr_bc_reg(t,i,"marginal")                   = q56_reward_cdr_bc_reg.m(i);
 oq56_luc_sens_bc_eligibility(t,i,"marginal")             = q56_luc_sens_bc_eligibility.m(i);
 oq56_cdr_bc_ded_credit(t,i,"marginal")                   = q56_cdr_bc_ded_credit.m(i);
 ...
 ov_reward_cdr_bc(t,i,"level")                            = vm_reward_cdr_bc.l(i);
 ov56_reward_cdr_bc_res(t,i,"level")                      = v56_reward_cdr_bc_res.l(i);
 ov56_reward_cdr_bc_ded(t,i,"level")                      = v56_reward_cdr_bc_ded.l(i);
 ov56_luc_sens_bc_eligibility(t,i,"level")                = v56_luc_sens_bc_eligibility.l(i);
 ov56_cdr_bc_ded_credit(t,i,"level")                      = v56_cdr_bc_ded_credit.l(i);
 ...
 oq56_reward_cdr_bc_res(t,i,"level")                      = q56_reward_cdr_bc_res.l(i);
 oq56_reward_cdr_bc_ded(t,i,"level")                      = q56_reward_cdr_bc_ded.l(i);
 oq56_reward_cdr_bc_reg(t,i,"level")                      = q56_reward_cdr_bc_reg.l(i);
 oq56_luc_sens_bc_eligibility(t,i,"level")                = q56_luc_sens_bc_eligibility.l(i);
 oq56_cdr_bc_ded_credit(t,i,"level")                      = q56_cdr_bc_ded_credit.l(i);
 ...
 ov_reward_cdr_bc(t,i,"upper")                            = vm_reward_cdr_bc.up(i);
 ov56_reward_cdr_bc_res(t,i,"upper")                      = v56_reward_cdr_bc_res.up(i);
 ov56_reward_cdr_bc_ded(t,i,"upper")                      = v56_reward_cdr_bc_ded.up(i);
 ov56_luc_sens_bc_eligibility(t,i,"upper")                = v56_luc_sens_bc_eligibility.up(i);
 ov56_cdr_bc_ded_credit(t,i,"upper")                      = v56_cdr_bc_ded_credit.up(i);
 ...
 oq56_reward_cdr_bc_res(t,i,"upper")                      = q56_reward_cdr_bc_res.up(i);
 oq56_reward_cdr_bc_ded(t,i,"upper")                      = q56_reward_cdr_bc_ded.up(i);
 oq56_reward_cdr_bc_reg(t,i,"upper")                      = q56_reward_cdr_bc_reg.up(i);
 oq56_luc_sens_bc_eligibility(t,i,"upper")                = q56_luc_sens_bc_eligibility.up(i);
 oq56_cdr_bc_ded_credit(t,i,"upper")                      = q56_cdr_bc_ded_credit.up(i);
 ...
 ov_reward_cdr_bc(t,i,"lower")                            = vm_reward_cdr_bc.lo(i);
 ov56_reward_cdr_bc_res(t,i,"lower")                      = v56_reward_cdr_bc_res.lo(i);
 ov56_reward_cdr_bc_ded(t,i,"lower")                      = v56_reward_cdr_bc_ded.lo(i);
 ov56_luc_sens_bc_eligibility(t,i,"lower")                = v56_luc_sens_bc_eligibility.lo(i);
 ov56_cdr_bc_ded_credit(t,i,"lower")                      = v56_cdr_bc_ded_credit.lo(i);
 ...
 oq56_reward_cdr_bc_res(t,i,"lower")                      = q56_reward_cdr_bc_res.lo(i);
 oq56_reward_cdr_bc_ded(t,i,"lower")                      = q56_reward_cdr_bc_ded.lo(i);
 oq56_reward_cdr_bc_reg(t,i,"lower")                      = q56_reward_cdr_bc_reg.lo(i);
 oq56_luc_sens_bc_eligibility(t,i,"lower")                = q56_luc_sens_bc_eligibility.lo(i);
 oq56_cdr_bc_ded_credit(t,i,"lower")                      = q56_cdr_bc_ded_credit.lo(i);
