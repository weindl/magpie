...
*'
*' @authors Jan Philipp Dietrich, Jan Steinhauser, Isabelle Weindl


*###################### R SECTION START (MODULETYPES) ##########################
$Ifi "%bioenergy%" == "1st2ndgen_biomass_dec24" $include "./modules/60_bioenergy/1st2ndgen_biomass_dec24/realization.gms"
