...
parameters
 ...
 ov63_biochar_applied_sys(t,i,bc_sys63,type)             Regional applied biochar by system (mio. tDM per yr)
 ov63_biochar_notapplied_sys(t,i,bc_sys63,type)          Regional biochar mass balance term for produced and not applied biochar by system (mio. tDM per yr)
 ...
 ov_cdr_bc(t,i,type)                                     Expected annual CDR from biochar (mio. tC per yr)
 ...
 oq63_cdr_biochar(t,i,type)                              Expected annual carbon removal from biochar (mio. tC per yr)
 ...
 oq63_biochar_application_balance_sys(t,i,bc_sys63,type) Regional mass balance of biochar by production system (mio. tDM per yr)
