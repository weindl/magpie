...
sets
  ...
  scen2nd63 second generation bioenergy scenarios
    / PIK_GDP,
      PIK_H2C,
      PIK_HBL,
      PIK_HOS,
...
sets
   ...
   kbe63(kall) dedicated bioenergy crops used as feedstock for biochar production
        / betr, begr /

   scen2ndres63 scenarios for the use of residues as biochar feedstock
